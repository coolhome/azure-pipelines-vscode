...
### 5b.2 `condition: $[ and(succeeded(), eq(variables.flag, 'yes')) ]`
...
### 5b.3 `script: "echo Hello $(Build.BuildId) from $(Agent.Name)"`
...
### 5b.4 `${{ if eq(parameters.os, 'linux') }}:` as a mapping key
